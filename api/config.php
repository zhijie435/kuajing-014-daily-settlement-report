...
define('SETTLEMENT_AUTO_GENERATE', env('SETTLEMENT_AUTO_GENERATE', true));
define('SETTLEMENT_CUTOFF_TIME', env('SETTLEMENT_CUTOFF_TIME', '23:59:59'));
define('SETTLEMENT_EXPORT_BATCH_SIZE', (int)env('SETTLEMENT_EXPORT_BATCH_SIZE', 1000));
define('SETTLEMENT_CHECK_REQUIRE_REMARK', env('SETTLEMENT_CHECK_REQUIRE_REMARK', false));

define('EXPORT_MAX_ROWS', (int)env('EXPORT_MAX_ROWS', 10000));
