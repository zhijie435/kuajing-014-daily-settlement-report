...
-- ============================================
-- 预扣公式表 withholding_formulas
-- ============================================
DROP TABLE IF EXISTS `withholding_formulas`;
CREATE TABLE `withholding_formulas` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
-- ============================================
-- 预扣明细表 withholding_details
-- ============================================
DROP TABLE IF EXISTS `withholding_details`;
...
CREATE TABLE `operation_logs` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `target_type` varchar(50) NOT NULL COMMENT '操作对象类型:fund_flow-资金流水 withholding_detail-预扣明细',
  `target_id` int(11) NOT NULL COMMENT '操作对象ID',
  `action` varchar(50) NOT NULL COMMENT '操作动作:create-创建 update-更新 status_change-状态变更 remark-备注',
